...
/*  BST312.h
  ...
  Other user created objects must have the << operator overloaded for output.
  The relational operators for itemType must be overloaded!

  Modified by Ashley Andrey
  4/22/19
...
void BST_312<ItemType>::insertItem(TreeNode *&t, const ItemType &newItem) {
    ...
    else return; //case where newItem is already in tree
}
